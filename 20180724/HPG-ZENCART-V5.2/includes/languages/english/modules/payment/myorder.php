...
define('MODULE_PAYMENT_MYORDER_TEXT_CONFIG_9_1', 'MyOrder Transaction page URL<br />Default: <code>./myorderpayment.php</code><br />');
define('MODULE_PAYMENT_MYORDER_TEXT_CONFIG_9_2', 'MyOrder Transaction page URL');
define('MODULE_PAYMENT_MYORDER_TEXT_CREDIT_CARD_NUMBER', 'Card Number:');
define('MODULE_PAYMENT_MYORDER_TEXT_CREDIT_CARD_CVV', 'CVC/CVV2:');
define('MODULE_PAYMENT_MYORDER_TEXT_MONTH', 'Month');
define('MODULE_PAYMENT_MYORDER_TEXT_YEAR', 'Year');
define('MODULE_PAYMENT_MYORDER_TEXT_CREDIT_CARD_EXPIRES', 'Expiration Date:');
define('MODULE_PAYMENT_MYORDER_TEXT_JS_MYORDER_NUMBER', '* Card No.  Is Error !\n');
define('MODULE_PAYMENT_MYORDER_TEXT_JS_MYORDER_CVV', '* Cvc/Cvv2  Is Error !\n');
define('MODULE_PAYMENT_MYORDER_TEXT_JS_MYORDER_EXPIRES_MONTH', '* Credit Card Expires Month Is Error!\n');
define('MODULE_PAYMENT_MYORDER_TEXT_JS_MYORDER_EXPIRES_YEAR', '* Credit Card Expires Year Is Error!\n');
define('MODULE_PAYMENT_MYORDER_TEXT_JS_MYORDER_RESUBMIT','please be patient!');
define('MODULE_PAYMENT_MYORDER_TEXT_CONFIG_10_1', 'PrefixName');
define('MODULE_PAYMENT_MYORDER_TEXT_CONFIG_10_2', '订单号前缀名，不需要加-，默认已经添加');
?>