...
//  $Id: cardpay.php v1.0 2008-03-20 Jack $
  ...
  // 支付显示
  define('MODULE_PAYMENT_CARDPAY_TEXT_TITLE', "<span style='font-weight:bold;color: red' color='red'>Kreditkartenzahlung</span>"); //支付方式名称
  define('MODULE_PAYMENT_CARDPAY_TEXT_MARK', 'Kreditkartenzahlung'); //支付方式简介
  define('MODULE_PAYMENT_CARDPAY_TEXT_DESCRIPTION', 'Kreditkartenzahlung'); //支付方式描述
...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
  //信用卡信息
  define('MODULE_PAYMENT_CARDPAY_TEXT_CREDIT_CARD_NUMBER', 'Kartennummer:');
  define('MODULE_PAYMENT_CARDPAY_TEXT_CREDIT_CARD_CVV', 'CVV2/CSC:');
  define('MODULE_PAYMENT_CARDPAY_TEXT_CREDIT_CARD_EXPIRES', 'Deadline:');
  define('MODULE_PAYMENT_CARDPAY_TEXT_CREDIT_CARD_ISSUING_BANK', 'Akkreditivbank:');
  define('MODULE_PAYMENT_CARDPAY_TEXT_MONTH', 'Monat');
  define('MODULE_PAYMENT_CARDPAY_TEXT_YEAR', 'Jahr');
  
  //异常提示信息 
  define('MODULE_PAYMENT_CARDPAY_TEXT_ERROR_MSG_CARD_NUM',  'Kreditkartennummer ist falsch !\n');
  define('MODULE_PAYMENT_CARDPAY_TEXT_ERROR_MSG_CARD_TYPE', 'Kreditkartentyp wird nicht unterstützt !\n');
  define('MODULE_PAYMENT_CARDPAY_TEXT_ERROR_MSG_NONE_CARD', 'Zahlung wird jede Speicherkarten-Typ nicht unterstützt, kontaktieren Sie bitte die Web-Shop Kundenservice-Center !\n'); 
  define('MODULE_PAYMENT_CARDPAY_TEXT_ERROR_MSG_CARD_ALLOW','Wir unterstützen Kreditkartentyp : ');
  define('MODULE_PAYMENT_CARDPAY_TEXT_ERROR_MSG_EXP_YEAR',  'Gültigkeit des Jahres nicht korrekt !\n');
  define('MODULE_PAYMENT_CARDPAY_TEXT_ERROR_MSG_EXP_MONTH', 'Gültigkeit Monat falsche !\n');
  define('MODULE_PAYMENT_CARDPAY_TEXT_ERROR_MSG_EXPIRE',    'Kreditkarten Gültigkeit abgelaufen !\n');
  define('MODULE_PAYMENT_CARDPAY_TEXT_ERROR_MSG_CVV',       'Sicherheitscode Incorrect !\n');

  define('MODULE_PAYMENT_CARDPAY_TEXT_ERROR_MSG_ISSUING_BANK','Kreditkarte ausgebende Bank ist falsch !');
  define('MODULE_PAYMENT_CARDPAY_TEXT_ERROR_MSG_REFRESH',     'Warten Sie einen Moment, bitte die Zahlung nicht aktualisiert !');
  define('MODULE_PAYMENT_CARDPAY_TEXT_ERROR_MSG_RE_INPUT',    'Bitte erneut zu füllen !');
  define('MODULE_PAYMENT_CARDPAY_TEXT_ERROR_MSG_TIMEOUT',     'Payment Ausnahme, kontaktieren Sie bitte die Web-Shop Kundenservice-Center !');
 ...
 //返回结果		
 define('CARDPAY_PAYRESULT_SUCCESS','Herzlichen Glückwunsch, erfolgreicher Zahlung !');
 define('CARDPAY_PAYRESULT_FAIL','Leider ist der Zahlungsausfall ist der Grund : ');
 define('CARDPAY_PAYRESULT_WARNING','Leider ist der Zahlungsausfall , der Grund ist die Datenüberprüfung ist fehlgeschlagen, kontaktieren Sie bitte den Einkaufs Besitzer !');
 define('CARDPAY_PAYRESULT_PROCESSING','Zahlung ist jetzt Verarbeitung, bitte nicht die Zahlung innerhalb von 24 Stunden zu wiederholen !');
