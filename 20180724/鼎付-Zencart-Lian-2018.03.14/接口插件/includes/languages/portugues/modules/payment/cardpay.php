...
//  $Id: cardpay.php v1.0 2008-03-20 Jack $
  ...
  // 支付显示
  define('MODULE_PAYMENT_CARDPAY_TEXT_TITLE', "<span style='font-weight:bold;color: red' color='red'>Pagamento de cartão de crédito</span>"); //支付方式名称
  define('MODULE_PAYMENT_CARDPAY_TEXT_MARK', 'Pagamento de cartão de crédito'); //支付方式简介
  define('MODULE_PAYMENT_CARDPAY_TEXT_DESCRIPTION', 'Pagamento de cartão de crédito'); //支付方式描述
...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
  //信用卡信息
  define('MODULE_PAYMENT_CARDPAY_TEXT_CREDIT_CARD_NUMBER', 'Número de Cartão:');
  define('MODULE_PAYMENT_CARDPAY_TEXT_CREDIT_CARD_CVV', 'CVV2/CSC:');
  define('MODULE_PAYMENT_CARDPAY_TEXT_CREDIT_CARD_EXPIRES', 'Data Expirada:');
  define('MODULE_PAYMENT_CARDPAY_TEXT_CREDIT_CARD_ISSUING_BANK', 'Banco Emitente:');
  define('MODULE_PAYMENT_CARDPAY_TEXT_MONTH', 'mês');
  define('MODULE_PAYMENT_CARDPAY_TEXT_YEAR', 'ano');
  
  //异常提示信息 
  define('MODULE_PAYMENT_CARDPAY_TEXT_ERROR_MSG_CARD_NUM',  'Número do cartão de crédito está incorreta !\n');
  define('MODULE_PAYMENT_CARDPAY_TEXT_ERROR_MSG_CARD_TYPE', 'Tipo de cartão de crédito não é suportada !\n');
  define('MODULE_PAYMENT_CARDPAY_TEXT_ERROR_MSG_NONE_CARD', 'Pagamento não é suportado qualquer tipo de cartão, entre em contato com o centro de atendimento ao cliente da loja online !\n'); 
  define('MODULE_PAYMENT_CARDPAY_TEXT_ERROR_MSG_CARD_ALLOW','Apoiamos tipo de cartão de crédito : ');
  define('MODULE_PAYMENT_CARDPAY_TEXT_ERROR_MSG_EXP_YEAR',  'Validade do ano está incorreto !\n');
  define('MODULE_PAYMENT_CARDPAY_TEXT_ERROR_MSG_EXP_MONTH', 'Validade do mês está incorreta !\n');
  define('MODULE_PAYMENT_CARDPAY_TEXT_ERROR_MSG_EXPIRE',    'Validade do cartão de crédito expirou !\n');
  define('MODULE_PAYMENT_CARDPAY_TEXT_ERROR_MSG_CVV',       'Código de Segurança incorreto !\n');

  define('MODULE_PAYMENT_CARDPAY_TEXT_ERROR_MSG_ISSUING_BANK','Cartão de crédito banco emissor está incorreta !');
  define('MODULE_PAYMENT_CARDPAY_TEXT_ERROR_MSG_REFRESH',     'Espere um momento, por favor, não atualizar o pagamento !');
  define('MODULE_PAYMENT_CARDPAY_TEXT_ERROR_MSG_RE_INPUT',    'Por favor, volte a introduzir !');
  define('MODULE_PAYMENT_CARDPAY_TEXT_ERROR_MSG_TIMEOUT',     'Exceção de pagamento, entre em contato com o centro de atendimento ao cliente da loja online !');
 ...
 //返回结果		
 define('CARDPAY_PAYRESULT_SUCCESS','Parabéns, o pagamento for bem sucedida !');
 define('CARDPAY_PAYRESULT_FAIL','Desculpe, o pagamento é falha, a razão é : ');
 define('CARDPAY_PAYRESULT_WARNING','Desculpe, o pagamento é falha, a razão é a validação de dados falhou, por favor, entre em contato com o proprietário compras !');
 define('CARDPAY_PAYRESULT_PROCESSING','Pagamento agora é o processamento, por favor não repita o pagamento dentro de 24 horas !');
