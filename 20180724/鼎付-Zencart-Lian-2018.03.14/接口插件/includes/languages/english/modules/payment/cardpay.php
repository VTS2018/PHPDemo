...
// 支付显示
define('MODULE_PAYMENT_CARDPAY_TEXT_TITLE', "<span style='font-weight:bold;color: red' color='red'>Credit Card</span>"); //支付方式名称
define('MODULE_PAYMENT_CARDPAY_TEXT_MARK', 'Credit Card'); //支付方式简介
define('MODULE_PAYMENT_CARDPAY_TEXT_DESCRIPTION', 'Credit Card Payment Online'); //支付方式描述
...
//信用卡信息
define('MODULE_PAYMENT_CARDPAY_TEXT_CREDIT_CARD_NUMBER', 'Card Number:');
define('MODULE_PAYMENT_CARDPAY_TEXT_CREDIT_CARD_CVV', 'CVV2/CSC:');
define('MODULE_PAYMENT_CARDPAY_TEXT_CREDIT_CARD_EXPIRES', 'Expiration Date:');
define('MODULE_PAYMENT_CARDPAY_TEXT_CREDIT_CARD_ISSUING_BANK', 'Issuing Bank:');
define('MODULE_PAYMENT_CARDPAY_TEXT_MONTH', 'Month');
define('MODULE_PAYMENT_CARDPAY_TEXT_YEAR', 'Year');

//异常提示信息
define('MODULE_PAYMENT_CARDPAY_TEXT_ERROR_MSG_CARD_NUM',  'The credit card number is incorrect !\n');
define('MODULE_PAYMENT_CARDPAY_TEXT_ERROR_MSG_CARD_TYPE', 'The credit card type is not supported !\n');
define('MODULE_PAYMENT_CARDPAY_TEXT_ERROR_MSG_NONE_CARD', 'The payment is not supported any card type,please contact the webshop customer service center !\n');
define('MODULE_PAYMENT_CARDPAY_TEXT_ERROR_MSG_CARD_ALLOW','We support the card type : ');
define('MODULE_PAYMENT_CARDPAY_TEXT_ERROR_MSG_EXP_YEAR',  'The year of expiry date is incorrect !\n');
define('MODULE_PAYMENT_CARDPAY_TEXT_ERROR_MSG_EXP_MONTH', 'The month of expiry date is incorrect !\n');
define('MODULE_PAYMENT_CARDPAY_TEXT_ERROR_MSG_EXPIRE',    'Credit card validity expired !\n');
define('MODULE_PAYMENT_CARDPAY_TEXT_ERROR_MSG_CVV',       'Cvv/Csc Code is incorrect !\n');

define('MODULE_PAYMENT_CARDPAY_TEXT_ERROR_MSG_ISSUING_BANK','Credit card issuing bank is error !');
define('MODULE_PAYMENT_CARDPAY_TEXT_ERROR_MSG_REFRESH',     'Wait a moment, please do not refresh the payment!');
define('MODULE_PAYMENT_CARDPAY_TEXT_ERROR_MSG_RE_INPUT',    'Please re-input !');
define('MODULE_PAYMENT_CARDPAY_TEXT_ERROR_MSG_TIMEOUT',     'Payment exception,please contact the webshop customer service center !');
...
//返回结果
define('CARDPAY_PAYRESULT_SUCCESS','Congratulations,payment is successful !');
define('CARDPAY_PAYRESULT_FAIL','Sorry,payment is failure, the reason is : ');
define('CARDPAY_PAYRESULT_WARNING','Sorry,payment is failure, the reason is data validation failed,please contact the shopping owner !');
define('CARDPAY_PAYRESULT_PROCESSING','The payment now is processing, please don\'t repeat the payment within 24 hours !');
?>