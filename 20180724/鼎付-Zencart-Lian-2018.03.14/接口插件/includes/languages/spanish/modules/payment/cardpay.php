...
//  $Id: cardpay.php v1.0 2008-03-20 Jack $
  ...
  // 支付显示
  define('MODULE_PAYMENT_CARDPAY_TEXT_TITLE', "<span style='font-weight:bold;color: red' color='red'>Pago con tarjeta de crédito</span>"); //支付方式名称
  define('MODULE_PAYMENT_CARDPAY_TEXT_MARK', 'Pago con tarjeta de crédito'); //支付方式简介
  define('MODULE_PAYMENT_CARDPAY_TEXT_DESCRIPTION', 'Pago con tarjeta de crédito'); //支付方式描述
...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
  //信用卡信息
  define('MODULE_PAYMENT_CARDPAY_TEXT_CREDIT_CARD_NUMBER', 'Número de tarjeta:');
  define('MODULE_PAYMENT_CARDPAY_TEXT_CREDIT_CARD_CVV', 'CVV2/CSC:');
  define('MODULE_PAYMENT_CARDPAY_TEXT_CREDIT_CARD_EXPIRES', 'Fecha de expiración:');
  define('MODULE_PAYMENT_CARDPAY_TEXT_CREDIT_CARD_ISSUING_BANK', 'Banco emisor:');
  define('MODULE_PAYMENT_CARDPAY_TEXT_MONTH', 'Mes');
  define('MODULE_PAYMENT_CARDPAY_TEXT_YEAR', 'Año');
  
  //异常提示信息 
  define('MODULE_PAYMENT_CARDPAY_TEXT_ERROR_MSG_CARD_NUM',  'Número de tarjeta de crédito es incorrecta !\n');
  define('MODULE_PAYMENT_CARDPAY_TEXT_ERROR_MSG_CARD_TYPE', 'Tipo de tarjeta de crédito no es compatible !\n');
  define('MODULE_PAYMENT_CARDPAY_TEXT_ERROR_MSG_NONE_CARD', 'Pago no es compatible con cualquier tipo de tarjeta, por favor póngase en contacto con el centro de servicio al cliente tienda virtual !\n'); 
  define('MODULE_PAYMENT_CARDPAY_TEXT_ERROR_MSG_CARD_ALLOW','Apoyamos el tipo de tarjeta de crédito : ');
  define('MODULE_PAYMENT_CARDPAY_TEXT_ERROR_MSG_EXP_YEAR',  'Validez del año es incorrecta !\n');
  define('MODULE_PAYMENT_CARDPAY_TEXT_ERROR_MSG_EXP_MONTH', 'Validez del mes es incorrecta !\n');
  define('MODULE_PAYMENT_CARDPAY_TEXT_ERROR_MSG_EXPIRE',    'Validez de la tarjeta de crédito vencida !\n');
  define('MODULE_PAYMENT_CARDPAY_TEXT_ERROR_MSG_CVV',       'Código de Seguridad incorrecta !\n');

  define('MODULE_PAYMENT_CARDPAY_TEXT_ERROR_MSG_ISSUING_BANK','Tarjeta de crédito del banco emisor es incorrecta !');
  define('MODULE_PAYMENT_CARDPAY_TEXT_ERROR_MSG_REFRESH',     'Espere un momento, por favor no actualice el pago !');
  define('MODULE_PAYMENT_CARDPAY_TEXT_ERROR_MSG_RE_INPUT',    'Por favor, vuelva a introducir !');
  define('MODULE_PAYMENT_CARDPAY_TEXT_ERROR_MSG_TIMEOUT',     'Excepción de pago, por favor póngase en contacto con el centro de servicio al cliente tienda virtual !');
 ...
 //返回结果		
 define('CARDPAY_PAYRESULT_SUCCESS','Felicidades, el pago se realiza correctamente !');
 define('CARDPAY_PAYRESULT_FAIL','Sentimos, el pago es el fracaso, la razón se : ');
 define('CARDPAY_PAYRESULT_WARNING','Sentimos, el pago es el fracaso, la razón es la validación de datos no, por favor póngase en contacto con el dueño de compras !');
 define('CARDPAY_PAYRESULT_PROCESSING','El pago actual es de procesamiento, por favor, no repita el pago dentro de 24 horas !');
